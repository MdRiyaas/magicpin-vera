...
def compose_template(category: dict, merchant: dict, trigger: dict,
    ...
    if kind == "regulation_change":
        ...
        if item:
            ...
            body = (f"{name}, a regulatory change in your category takes effect {deadline}. "
                    f"Want me to summarise what it means for your practice and draft a compliance checklist? Reply YES?")
